...
from university.models import staff, profession, matyan, group, student, Points, PointType, Exam
...
class Add(generic.FormView):
    ...
    success_url = reverse_lazy('aministration:add-point')
...
class Edit(generic.UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy('aministration:edit-point', kwargs={'pk':int(self.kwargs['pk'])})
